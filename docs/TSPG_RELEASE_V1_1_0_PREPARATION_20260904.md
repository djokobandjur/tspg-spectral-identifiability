...
Reporting-level/reduced-matrix A52 verification is already supported by the staged compact evidence archives. The checkpoint-binary gate for full model-level public reproduction is now closed; remaining blockers are public-tree promotion/freeze and archival publication/verification.
