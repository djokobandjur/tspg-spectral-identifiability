...
The fresh materialization/execution session matched the captured core numerical stack: Python 3.12.3, PyTorch `2.8.0a0+5228986c39.nv25.06`, CUDA 12.9, and NVIDIA H200. The public audits deliberately omit host/container identifiers and local absolute paths. The next release blocker is now the exact non-PyTorch package lock captured from this successful clean-execution environment.
