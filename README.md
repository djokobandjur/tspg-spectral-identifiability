...
Source ImageNet images are not redistributed. Reproduction materials will include the split/index manifests needed to reconstruct the analyzed ImageNet-100 subsets from a legally obtained ImageNet copy.
