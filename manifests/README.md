...
- `LARGE_ARTIFACTS_SHA256.csv` — identities and roles of large artifacts that are not stored in ordinary Git history, including the H1-0011 M1 complement dependency.
