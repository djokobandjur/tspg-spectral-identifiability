...
- `TSPG_RELEASE_STATUS_v1_0_20260830.json` — current `v1.0.0` release state: GitHub release published and verified `6/6`, Zenodo version `1.0.0` published at DOI `10.5281/zenodo.22180107`, and post-publication public retrieval verified `14/14` exact SHA-256 with aggregate payload `3,535,908,885` bytes.
